# Generated by Django 3.2.16 on 2023-10-22 11:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(help_text='Идентификатор страницы для URL  разрешены символы латиницы, цифры, дефис и подчёркивания.', verbose_name='Идентификатор')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('locations', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='blog.location', verbose_name='Местоположение')),
            ],
            options={
